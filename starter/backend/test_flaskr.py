...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}@{}/{}" \
            .format('student', 'student', 'localhost:5432', self.database_name)
    ...
    def test_question_deletion(self):
        ...
        question_delete = Question.query \
            .filter(Question.id == question.id).one_or_none()
    ...
    def test_question_search(self):
        res = self.client() \
            .post('/questionSearch', json={"searchTerm": "clay"})
        data = json.loads(res.data)
    ...
    def test_404_question_search(self):
        res = self.client() \
            .post('/questionSearch', json={"search": "asjidaijsidj"})
        data = json.loads(res.data)
