...
def create_app(test_config=None):
    ...
    def get_questions():
        ...
        questions_query, total_questions = get_current_page(
          db.session.query(Question).join(Category).all(), page
        )
    ...
    def question_search():
        ...
        question_filter = Question.question.ilike(f"%{term}%")
        questions = Question.query.filter(question_filter).all()
